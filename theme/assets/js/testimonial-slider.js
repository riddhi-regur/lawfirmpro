	...
	document.querySelectorAll('.testimonial-slider').forEach((slider) => {
		...
		nav.innerHTML = `
				<button class="testimonial-slider-prev" aria-label="Previous">
					<img src="${window.location.origin}/wp-content/themes/lawfirmpro/theme/assets/images/Right.png" alt="Previous">
				</button>

				<button class="testimonial-slider-next" aria-label="Next">
					<img src="${window.location.origin}/wp-content/themes/lawfirmpro/theme/assets/images/Left.png" alt="Next">
				</button>
			`;
