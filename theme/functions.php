...
/**
 * lawfirmpro functions and definitions
 *
...
if (! defined('LAWFIRMPRO_VERSION')) {
	 ...
	 */
	define('LAWFIRMPRO_VERSION', '0.1.0');
}

if (! defined('LAWFIRMPRO_TYPOGRAPHY_CLASSES')) {
	/*
	 * Set Tailwind Typography classes for the front end, block editor and
	 * classic editor using the constant below.
	 *
	 * For the front end, these classes are added by the `lawfirmpro_content_class`
	 ...
	 */
	define(
		'LAWFIRMPRO_TYPOGRAPHY_CLASSES',
		'prose prose-neutral max-w-none prose-a:text-primary'
	);
}

if (! function_exists('lawfirmpro_setup')) :
	/**
	 ...
	 */
	function lawfirmpro_setup()
	{
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on lawfirmpro, use a find and replace
		 * to change 'lawfirmpro' to the name of your theme in all the template files.
		 */
		load_theme_textdomain('lawfirmpro', get_template_directory() . '/languages');
		...
		register_nav_menus(
			array(
				'menu-1' => __('Primary', 'lawfirmpro'),
				'menu-2' => __('Footer Menu', 'lawfirmpro'),
			)
		);
 ...
 */
function lawfirmpro_enqueue_block_editor_script()
{
	...
	if (
		...
		wp_add_inline_script('lawfirmpro-editor', "tailwindTypographyClasses = '" . esc_attr(LAWFIRMPRO_TYPOGRAPHY_CLASSES) . "'.split(' ');", 'before');
	}
}
 ...
 * @return array
 */
function lawfirmpro_modify_heading_levels($args, $block_type)
{
...
function tw_block_theme_setup()
{
	add_theme_support('block-templates');
}
add_action('after_setup_theme', 'tw_block_theme_setup');

function tw_enqueue_block_assets()
{
...
require_once get_template_directory() . '/inc/cpt-practice-areas.php';
require_once get_template_directory() . '/inc/cpt-offers.php';
require_once get_template_directory() . '/inc/cpt-attorneys.php';
