...
function lawfirmpro_register_articles_cpt()
{
    ...
    $labels = array(
        'name'          => __('Articles', 'lawfirmpro-core'),
        'singular_name' => __('Article', 'lawfirmpro-core'),
        'add_new_item'  => __('Add Article', 'lawfirmpro-core'),
        'edit_item'     => __('Edit Article', 'lawfirmpro-core'),
        'menu_name'     => __('Articles', 'lawfirmpro-core'),
    );
