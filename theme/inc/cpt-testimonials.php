...
{
    $labels = array(
        'name'          => __('Testimonials', 'lawfirmpro-core'),
        'singular_name' => __('Testimonial', 'lawfirmpro-core'),
        'add_new_item'  => __('Add Testimonial', 'lawfirmpro-core'),
        'edit_item'     => __('Edit Testimonial', 'lawfirmpro-core'),
        'menu_name'     => __('Testimonials', 'lawfirmpro-core'),
    );
...
function lawfirmpro_add_testimonial_fields_metabox()
{
    add_meta_box(
        ...
        __('Testimonial Details', 'lawfirmpro-core'),
...
?>
    <p>
        <label for="testimonial_location" style="display:block; margin-bottom:5px; font-weight:bold;"><?php _e('Client Location:', 'lawfirmpro-core'); ?></label>
    ...
    <p>
        <label for="testimonial_rating" style="display:block; margin-bottom:5px; font-weight:bold;"><?php _e('Star Rating (Type 1 to 5):', 'lawfirmpro-core'); ?></label>
