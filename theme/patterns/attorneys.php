    ...
    <div class="wp-block-group alignfull" style="margin-top:50px"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical","flexWrap":"wrap","justifyContent":"center"}} -->
        <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"margin":{"bottom":"20px"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
            <div class="wp-block-group" style="margin-bottom:20px"><!-- wp:heading {"className":"practice-area-heading","style":{"typography":{"textAlign":"center","fontStyle":"normal","fontWeight":"800","lineHeight":"1.1","letterSpacing":"0px","fontSize":"56px"},"spacing":{"margin":{"right":"200px","left":"200px"}}},"fontFamily":"plus-jakarta-sans"} -->
                <h2 class="wp-block-heading has-text-align-center practice-area-heading has-plus-jakarta-sans-font-family" style="margin-right:200px;margin-left:200px;font-size:56px;font-style:normal;font-weight:800;letter-spacing:0px;line-height:1.1">Meet Our Experienced Attorneys</h2>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-group custom-posts-grid"><!-- wp:query {"queryId":78,"query":{"perPage":9,"pages":0,"offset":0,"postType":"attorney","order":"asc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[]},"metadata":{"categories":["posts"],"patternName":"core/query-grid-posts","name":"Grid"}} -->
                <div class="wp-block-query"><!-- wp:post-template {"layout":{"type":"grid","columnCount":3}} -->
                    <!-- wp:post-featured-image {"height":"430px","className":"practice-area-post-image"} /-->

                    <!-- wp:group {"style":{"spacing":{"margin":{"top":"30px","bottom":"50px"}}},"layout":{"inherit":false}} -->
                    <div class="wp-block-group" style="margin-top:30px;margin-bottom:50px"><!-- wp:post-title {"textAlign":"center","isLink":true,"className":"practice-area-post-tile","style":{"typography":{"fontStyle":"normal","fontWeight":"700","lineHeight":"0.3","letterSpacing":"0px","fontSize":"24px"}},"fontFamily":"plus-jakarta-sans"} /-->

                        <!-- wp:post-excerpt {"textAlign":"center","showMoreOnNewLine":false,"className":"practice-area-paragraph","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-9"}}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"400","letterSpacing":"0px"}},"textColor":"accent-9","fontFamily":"plus-jakarta-sans"} /-->

                        <!-- wp:social-links {"iconColor":"accent-2","iconColorValue":"#CECECE","className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"center"}} -->
                        <ul class="wp-block-social-links has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://www.facebook.com/","service":"facebook","label":""} /-->
